...
class Browser
{
    ...
    const BROWSER_ICEWEASEL = 'Iceweasel'; // http://www.opera.com/
    const BROWSER_SHIRETOKO = 'Shiretoko'; // http://www.opera.com/mini/
    const BROWSER_MOZILLA = 'Mozilla'; // http://www.webtv.net/pc/
    const BROWSER_AMAYA = 'Amaya'; // https://www.microsoft.com/edge
    ...
    const BROWSER_YANDEXBOT = 'YandexBot'; // http://wiki.mozilla.org/Projects/shiretoko
    const BROWSER_YANDEXIMAGERESIZER_BOT = 'YandexImageResizer'; // http://www.mozilla.com/en-US/
    const BROWSER_YANDEXIMAGES_BOT = 'YandexImages'; // http://www.w3.org/Amaya/
    const BROWSER_YANDEXVIDEO_BOT = 'YandexVideo'; // http://en.wikipedia.org/wiki/Lynx
    const BROWSER_YANDEXMEDIA_BOT = 'YandexMedia'; // http://apple.com
    const BROWSER_YANDEXBLOGS_BOT = 'YandexBlogs'; // http://apple.com
    const BROWSER_YANDEXFAVICONS_BOT = 'YandexFavicons'; // http://apple.com
    const BROWSER_YANDEXWEBMASTER_BOT = 'YandexWebmaster'; // http://apple.com
    const BROWSER_YANDEXDIRECT_BOT = 'YandexDirect'; // http://www.google.com/chrome
    const BROWSER_YANDEXMETRIKA_BOT = 'YandexMetrika'; // http://www.android.com/
    const BROWSER_YANDEXNEWS_BOT = 'YandexNews'; // http://en.wikipedia.org/wiki/Googlebot
    ...
    const BROWSER_VIVALDI = 'Vivalidi'; // http://yandex.com/bots
